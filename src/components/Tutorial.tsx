...
const Tutorial: React.FC = () => {
  return (
    <section className='flex flex-col items-center justify-center gap-8 md:mx-20'>
      ...
      <div className='flex max-w-sm flex-col items-center justify-center gap-6'>
        ...
        <button className='mr-auto border-b border-cyan-400 text-cyan-400'>See how Fylo works</button>
      </div>
    </section>
  );
};
